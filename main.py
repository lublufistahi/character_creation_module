...
def attack(char_name: str, char_class: str) -> str:
    """Выдает значение полученного урона противником."""
    ...
    if char_class == 'healer':
        ...
        return str(start_training)


def defence(char_name: str, char_class: str) -> str:
    """Выдает значение заблокированного урона героем."""
    if char_class == 'warrior':
        return (
...
def special(char_name: str, char_class: str) -> str:
    """Выдает значение полученных очков особых умений героем."""
    if char_class == 'warrior':
        return (
